...
Double_t weight[9];
TFile* f1 = new TFile("./plj-hist/result-loose/cutLEP-outpljDMuon_hb.root");
TFile* f2 = new TFile("./plj-hist/result-loose/cutLEP-outDMuon_hb.root");
 
TH1F* h1 = (TH1F*)f1->Get("hb_cutLEP-outpljDMuon");
TH1F* h2 = (TH1F*)f2->Get("hb_cutLEP-outDMuon");
void draw(){
...
void open(Int_t i){
    ...
    ifstream f1;
    f1.open(Form("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/fit/result/fakerate_pt%0.f_%0.f.txt",lowpt[i],highpt[i]));
