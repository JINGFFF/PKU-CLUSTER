...
// Tue Oct  9 00:33:17 2018 by ROOT version 6.06/01
// from TTree demo/demo
// found on file: ToutZA-an.root
//////////////////////////////////////////////////////////
...
#ifdef SRplot_cxx
SRplot::SRplot(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ToutZA-an.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ToutZA-an.root");
      }
...
Int_t SRplot::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SRplot::LoadTree(Long64_t entry)
{
...
void SRplot::Show(Long64_t entry)
{
...
Int_t SRplot::Cut(Long64_t entry)
{
